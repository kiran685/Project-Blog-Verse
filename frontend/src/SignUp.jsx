    ...
    return(
        <div className="flex items-center flex-col mt-10 gap-5 ">
            ...
            <div className="w-[90%] flex flex-col gap-2">
                ...
                <button className="w-[90%] bg-purple-500 py-4 text-white rounded-xl font-semibold mt-3" >Create Account</button>
                ...
                <spam className="text-purple-700 font-semibold">Sign In Here </spam>

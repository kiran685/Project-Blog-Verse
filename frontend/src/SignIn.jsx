        ...
        <div className=" w-full flex items-center  flex-col justify-center  gap-5">
            ...
            <div className="w-[90%] flex flex-col justify-center items-center  gap-2">
                ...
                <div className="w-[90%] flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="sample@gmail.com" className="border-1 border-gray-600 py-4 px-3  rounded-2xl focus:outline-none focus:border-purple-500">
                    </input>
                    <p className="text-md text-black font-semibold ">Password</p>
                    <input type="text" placeholder="sample123" className="border-1 border-gray-600 py-4 px-3  rounded-2xl focus:outline-none focus:border-purple-500">
                    </input>
                </div>
                 <div className="flex gap-2 w-[90%] py-5 px-4 rounded-xl justify-between">
                    <div className="flex gap-2">
                    <input type="checkbox" name="" id="" />
                    <p className="text-md text-black font-semibold">Remember Me</p>
                    </div>
                    <p className="flex justify-items-end text-blue-700 font-bold">Forget Paswword?</p>
                </div>
                <button className="w-[90%] bg-purple-500 hover:bg-pink-950  py-4 text-white rounded xl font-semibold">Sign In</button>
